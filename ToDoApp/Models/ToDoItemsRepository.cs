...
namespace ToDoApp.Models
{
    public static class ToDoItemsRepository
    {
        ...
        {
            new ToDoItem {  Id = 1, Name = "Item 1", IsCompleted = false},
            new ToDoItem {  Id = 2, Name = "Item 2", IsCompleted = false},
            new ToDoItem {  Id = 3, Name = "Item 3", IsCompleted = false},
            new ToDoItem {  Id = 4, Name = "Item 4", IsCompleted = false},
        };
